...
ui <- navbarPage(
  theme = bs_theme(bootswatch = "minty"),
    ...
    inverse = TRUE,
    nav_panel(title = "Start Here", 
              p("What might you and a shrub have in common? A love of the beach!"),
              card(
                card_header(),
                card_body(
                  markdown("[Read the Full Article Here!](https://link.springer.com/article/10.1007/s11258-024-01453-2)")
                ),
                  value_box(
                    title = "Value box",
                    value = 100,
                  ...
                  card(
                    card_header("Card header 2"),
                    "Just checking this out"
                  )
                )),
    nav_panel(title = "Coding Time: Pearson's Correlation", 
    ...
    nav_menu(
      ...
      align = "right",
      nav_item(tags$a("Article: Protectors of the Coast", href = "https://magazine.moravian.edu/protectors-of-the-coast/")),
      nav_item(tags$a("What is an R Shiny App?", href = "https://shiny.posit.co"))
    )
)
...
server <- function(input, output) {
  output$pdfview <- renderUI({
    tags$iframe(style="height:600px; width:100%", src="Woods_Zinnert_2024.pdf")
  })
}
...
inverse = TRUE,
  ...
  nav_menu(
    title = "Links",
    align = "right",
    nav_item(tags$a("News Story", href = "https://magazine.moravian.edu/protectors-of-the-coast/")),
    nav_item(tags$a("What is an R Shiny App?", href = "https://shiny.posit.co"))
  )
)
